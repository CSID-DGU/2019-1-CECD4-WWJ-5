...
from sentiment import userEmotion
from sentiment import userSent
...
if __name__ == '__main__':
    ...
    while True:
        ...
        for x,y in user_lists:
            sent_score = userSent.user_sentiment_analysis(sentiment_data_frame, x)
            emot_score = userEmotion.user_emotion_analysis(emotion_data_frame,x)
            print (sent_score)
            print (emot_score)
